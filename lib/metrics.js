...
const metric = {
  http: {
    requests: {
      ...
      buckets: new client.Histogram('http_request_duration_buckets_milliseconds', 'request duration buckets in milliseconds. Bucket size set to 500 and 2000 ms to enable apdex calculations with a T of 300ms', ['method', 'path', 'status'], { buckets: [ 500, 2000 ] })
    }
  },
  node: {
